...
const std::string CommandPermissions::ROOT = "servermanager.command";
const std::string CommandPermissions::PREFIX = ROOT + ".";

Permission *CommandPermissions::registerWhitelist(Permission *parent)
{
...
Permission *CommandPermissions::registerBan(Permission *parent)
{
...
Permission *CommandPermissions::registerUnban(Permission *parent)
{
...
Permission *CommandPermissions::registerOp(Permission *parent)
{
...
Permission *CommandPermissions::registerSave(Permission *parent) {
...
Permission *CommandPermissions::registerTime(Permission *parent)
{
	...
	DefaultPermissions::registerPermission(PREFIX + "time.query", "Allows the user query the time", time);
	DefaultPermissions::registerPermission(PREFIX + "time.start", "Allows the user to restart the time", time);
	DefaultPermissions::registerPermission(PREFIX + "time.stop", "Allows the user to stop the time", time);
...
{
	Permission *commands = DefaultPermissions::registerPermission(ROOT, "Gives the user the ability to use all ServerManager commands", parent);
